...
public class CustomFullscreenRendererFeature : ScriptableRendererFeature
{
    ...
    public class FullScreenRenderPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            var field = typeof(RenderingData).GetField("commandBuffer", BindingFlags.NonPublic | BindingFlags.Instance);
            var value = field.GetValue(renderingData);
            
            var cmd = value as CommandBuffer;
